...
class Kama_Breadcrumbs {
	...
	static $args = array(
		...
		'title_patt'      => '<li itemprop="itemListElement active" itemscope itemtype="http://schema.org/ListItem"><span class="kb_title">%s</span><meta itemprop="position" content="2" /></li>',
	...
	function get_crumbs( $sep, $l10n, $args ) {
		global $post, $wp_query, $wp_post_types, $pos;
		...
		if ( 1 ) {
			...
			elseif ( $mark === 'schema.org' ) {
				...
				$mark = array(
					'wrappatt'  => '<ol class=" breadcrumb kama_breadcrumbs my-0" itemscope itemtype="http://schema.org/BreadcrumbList">%s</ol>',
					'linkpatt'  => '<li itemprop=" breadcrumb-item itemListElement" itemscope itemtype="http://schema.org/ListItem"><a href="%s" itemprop="item"><span itemprop="name">%s</span></a><meta itemprop="position" content=" '. $pos++ .' "/></li>',
					'sep_after' => '',
				);
